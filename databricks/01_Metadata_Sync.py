...
# MAGIC
# MAGIC While notebook can be used interactively or as a script that can be used in a job - it is written for interactive use and generative AI task understanding. This notebook has the following sections that are all executed in series:
# MAGIC
...
PUBMED_SOURCE_METADATA_BUCKET = f"s3://pmc-oa-opendata/oa_comm/xml/metadata/csv/"
